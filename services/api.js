...
export const scanNode = (studentId, nodeId) =>
  api.post("/scan", { studentId, nodeId });
export const getNodes = () => api.get("/nodes");

// Admin User Management
export const getUsers = () => api.get("/users");
export const updateUserScore = (studentId, totalScore) =>
  api.put(`/users/${encodeURIComponent(studentId)}`, { totalScore });
